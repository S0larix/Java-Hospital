 ...
 * @author Lisa
 */
public class SousMenuModifier extends javax.swing.JFrame {

    /**
     * Creates new form ajouter
     */
    public SousMenuModifier() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SousMenuModifier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SousMenuModifier().setVisible(true);
            }
        });
    }
