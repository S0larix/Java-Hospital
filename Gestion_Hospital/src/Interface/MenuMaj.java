 ...
 * @author Lisa
 */
public class MenuMaj extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BoutonModifier.setText("Modifier une entrée");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuMaj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
